...
export default function AppShell() {
  ...
  return (
    <div className="flex min-h-screen flex-col print:bg-white">
      <header className="bg-zinc-900 text-white print:break-inside-avoid print:bg-white print:text-zinc-900 print:shadow-none">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs font-medium uppercase tracking-widest text-zinc-400 print:text-zinc-600">
          ...
          <div className="w-full sm:w-auto sm:min-w-[14rem] sm:max-w-md sm:text-right">
            <label htmlFor="header-service-name" className="text-xs text-zinc-500 print:text-zinc-600">
              Police service
            </label>
            <input
              ...
              className="mt-0.5 w-full rounded border border-zinc-600 bg-zinc-800 px-2.5 py-1.5 text-sm text-zinc-100 placeholder:text-zinc-500 focus:border-zinc-400 focus:outline-none focus:ring-1 focus:ring-zinc-400 print:border-zinc-300 print:bg-white print:text-zinc-900 print:placeholder:text-zinc-400"
            />
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 bg-zinc-50 print:bg-white" role="tabpanel">
